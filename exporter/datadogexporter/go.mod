...
require (
	...
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.50.0-rc.2 // indirect
	github.com/DataDog/datadog-agent/pkg/remoteconfig/state v0.50.0-rc.2 // indirect
	github.com/DataDog/datadog-agent/pkg/util/cgroups v0.50.0-rc.2 // indirect
	github.com/DataDog/datadog-agent/pkg/util/log v0.50.0-rc.2 // indirect
	github.com/DataDog/datadog-agent/pkg/util/pointer v0.50.0-rc.2 // indirect
